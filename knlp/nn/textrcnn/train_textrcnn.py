...
from knlp.nn.textrcnn.textrcnn import TextRCNN
...
class TrainTextRCNN(TrainTextClassification):
    """
    TextRCNN模型训练
    """
    ...
    def __init__(self, vectors_path: str = None, model_hyperparameters: dict = {}, optimizer_hyperparameters: dict = {},
        ...
        if not vectors_path:
            ...
            self.model = TextRCNN(self.train_dataset.vocab_size, self.train_dataset.labelset_size,
        ...
        # 使用预训练的词向量
            ...
            self.model = TextRCNN(vectors.vocab_size, self.train_dataset.labelset_size,
                                  **model_hyperparameters).to(self.device)

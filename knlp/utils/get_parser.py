...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data_dir", type=str, required=True, help="data dir",default='/media/csu001/软件/mrc_ner/zh_msra')
    parser.add_argument("--max_keep_ckpt", default=3, type=int, help="the number of keeping ckpt max.")
    parser.add_argument("--bert_config_dir", type=str, required=True, help="bert config dir",default='/media/csu001/代码文件/CLUE/baselines/models_pytorch/mrc_pytorch/check_points/prev_trained_model/bert')

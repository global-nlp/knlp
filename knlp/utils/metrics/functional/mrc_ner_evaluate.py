...
from knlp.utils.metrics.functional import flat_span_f1
from knlp.utils.metrics.functional import nest_span_f1
...
def flat_transform_bmes_label(start_labels, end_labels, span_labels, ner_cate, threshold=0.5):
    ...
    for tmp_start in start_labels:
        ...
        if len(tmp_end) == 0:
            ...
            tmp_end = min(tmp_end)
        # print(span_labels[tmp_start][tmp_end])

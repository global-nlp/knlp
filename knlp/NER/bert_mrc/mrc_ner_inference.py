...
set_random_seed(0)
from knlp.NER.bert_mrc.mrc_ner_trainer import BertLabeling
from tokenizers import BertWordPieceTokenizer
from knlp.data.NER_data.mrc_ner_dataset import MRCNERDataset
from knlp.utils.metrics.functional.query_span_f1 import extract_flat_spans, extract_nested_spans
...
def get_query_index_to_label_cate(dataset_sign):
    ...
    elif dataset_sign == "msra":
        return {1: "NS", 2: "NR", 3: "NT"}
...
def main():
    ...
    query2label_dict = get_query_index_to_label_cate(args.dataset_sign)  # fix it if needed

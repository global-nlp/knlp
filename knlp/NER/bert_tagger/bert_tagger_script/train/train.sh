...
OUTPUT_DIR=${REPO_PATH}/model/bert/${TIME}/${FILE}_chinese_lr${LR}_drop${MRC_DROPOUT}_norm${MAXNORM}_weight${SPAN_WEIGHT}_warmup${WARMUP}_maxlen${MAXLEN}
mkdir -p ${OUTPUT_DIR}


CUDA_VISIBLE_DEVICES=0 python3 ${REPO_PATH}/NER/bert_tagger/bert_tagger_trainer.py \
--gpus="1" \

...
resfiles[0]='./'$base_dir$task_type'/'$datasets"/results/$1_eval_b.txt"  # output of model1;  Format:  token true_label pred_label  (delimiter = " ")
resfiles[1]='./'$base_dir$task_type'/'$datasets"/results/$2_eval_b.txt"   # output of model2   Format:  token true_label pred_label  (delimiter = " ")

...
def genHistTex(dict_breakdown, path_template, path_tex_base, corpus_type, model_type, dict_attr_range,
               dict_interval2F1number):
...
for block in all_cont.split("# "):
    ...
    if block.find("holistic results") != -1:
        print("******************************9090909")
        print(block)
        print("******************************9090909")
...
genHistTex(dict_breakdown_m1, path_template_breakdown, path_tex_base_breakdown, corpus_type, model_name1,
           data_mn_attr_range[corpus_type][model_name1], dict_data_bucketInfo[corpus_type])
genHistTex(dict_breakdown_m2, path_template_breakdown, path_tex_base_breakdown, corpus_type, model_name2,
           data_mn_attr_range[corpus_type][model_name2], dict_data_bucketInfo[corpus_type])

genSelfDiagTex(dict_self_diag_m1, path_template_selfdiag, path_tex_base_selfdiag, corpus_type, model_name1,
               data_mn_attr_range[corpus_type][model_name1])
genSelfDiagTex(dict_self_diag_m2, path_template_selfdiag, path_tex_base_selfdiag, corpus_type, model_name2,
               data_mn_attr_range[corpus_type][model_name1])

genAidedDiagHist(dict_aided_diag_hist_m1_2, path_template_selfdiag, path_tex_base_aideddiag, corpus_type,
                 model_name1 + "_" + model_name2, data_mn_attr_range[corpus_type][model_name1])

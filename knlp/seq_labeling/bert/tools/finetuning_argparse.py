...
def get_argparse():
    ...
    parser.add_argument("--data_dir", default="../../../data/cluener_public", type=str, required=True,
                        help="The input data dir. Should contain the training files for the CoNLL-2003 NER task.", )
    parser.add_argument("--model_type", default=None, type=str, required=True,
                        help="Model type selected in the list: ")
    parser.add_argument("--model_name_or_path", default="../../../model/bert/Chinese_wwm", type=str, required=True,
                        help="Path to pre-trained model or shortcut name selected in the list: " )
    parser.add_argument("--output_dir", default="../../../model/bert/output_model", type=str, required=True,
